...
#
# BioPerl module for Bio::SearchIO::hmmsearch3
#
...
Bio::SearchIO::hmmsearch3 - DESCRIPTION of Object
...
package Bio::SearchIO::hmmsearch3;
...
#			   grab hsp data from table, push into @hsp;
			   if(
			       ...
			       my @vals = ($hmmstart, $hmmstop, $qalistart, $qalistop, $score, $ceval, $ieval, '', '', '', '');
