...
=head1 NAME
  ...
  build_profile.pl - builds SPADA-compatible HMM profile from one or more protein alignments
...
=head1 SYNOPSIS
  ...
  Options:
    ...
    -c (--cfg)    config file
    -a (--aln)    directory containing input alignments
    -h (--hmm)    output directory containing built HMMs
